...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN ASU!?
            ...
            + 'FN:﷽𝑩2𝑲 𝑿-𝑷𝑳𝑶𝑰𝑻﷽\n' // NAMA OWNER BOT
            + 'ORG:Creator ﷽𝑩2𝑲 𝑿-𝑷𝑳𝑶𝑰𝑻﷽;\n' // KASIH CREDITS GUA Bang LENT JANCOK!!!
            + 'TEL;type=CELL;type=VOICE;waid=6283830766659:+62 83830766659\n' // GANTI NOMOR LU
            + 'END:VCARD'
prefix = '/'
blocked = []
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				...
				success: '*❬ SUCCESS ❭* _Sudah jadi tod..._',
				error: {
			...
			const ownerNumber = ["6283830766659@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["6283830766659@s.whatsapp.net"] // GANTI NOMOR LU
